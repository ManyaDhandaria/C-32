...
function draw() {
 if(backgroundImg)
  ...
  rectMode(CENTER);
  ground.display();
  box1.display("lightblue");
  box2.display("lightblue");
  ...
  box15.display("violet");
  py1.display(rgb(229, 116, 117),)
  py2.display(rgb(229, 116, 117), )
  py3.display(rgb(229, 116, 117),)
  py4.display(rgb(110, 71, 102), )
  py5.display(rgb(110, 71, 102), )
  py6.display(rgb(251, 189, 76), )
